...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import gperf_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1a1c6b14-54f6-533d-8383-74cd7377aa70"))
platforms = [Pkg.Artifacts.unpack_platform(e, "gperf", artifacts_toml) for e in artifacts["gperf"]]
...
if best_platform === nothing
    @debug("Unable to load gperf; unsupported platform $(triplet(platform_key_abi()))")
else
